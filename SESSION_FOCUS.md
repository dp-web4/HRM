...
*Auto-generated 2026-09-03 07:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 314 | last: 2026-09-03
  > Last session: *Session 314 (v2.0 ENHANCED): creating phase. I want to remember that the real work isn't in fin......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (165 sessions)
