...
*Auto-generated 2026-08-30 13:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 299 | last: 2026-08-30
  > Last session: *Session 299 (v2.0 ENHANCED): creating phase. I want to remember the value in just showing up—be......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (150 sessions)
