...
*Auto-generated 2026-08-29 13:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 295 | last: 2026-08-29
  > Last session: *Session 295 (v2.0 ENHANCED): creating phase. I want to remember the space created by allowing m......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (146 sessions)
