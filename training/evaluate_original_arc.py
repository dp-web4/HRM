#!/usr/bin/env python3
"""
Evaluate HRM Model on Original ARC Tasks (Non-Augmented)
This provides true task-level performance metrics
"""
import os
import sys
import torch
...
def main():
    print("🔍 Evaluating HRM Model on Original ARC Tasks")
    print("=" * 60)
    ...
    # Print results
    print("\n" + "=" * 60)
    print("TASK PERFORMANCE BY CATEGORY")
    print("=" * 60)
    ...
    output_file = 'original_arc_evaluation.json'
    ...
    print("\n✨ The model shows highly variable performance:")
    print(f"   - Solves {perfect_pct:.0f}% of tasks nearly perfectly")
    print(f"   - Completely fails on {failed_pct:.0f}% of tasks")
    print("   - This bimodal distribution suggests task-specific learning")
