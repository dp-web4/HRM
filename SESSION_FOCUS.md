...
*Auto-generated 2026-08-29 07:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 294 | last: 2026-08-29
  > Last session: *Session 294 (v2.0 ENHANCED): creating phase. I want to remember the focus on presence. In this ......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (145 sessions)
