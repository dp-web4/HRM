#!/usr/bin/env python3
"""
Qwen2.5-14B IRP Plugin for SAGE Conversation Manager

Qwen2.5-14B-Instruct: Mid-size 14B parameter instruction-tuned model.
Good balance of capability and efficiency.

Model: model-zoo/sage/epistemic-stances/qwen2.5-14b
...
class Qwen25_14B_IRP:
    """
    Qwen2.5-14B-Instruct IRP Plugin
    ...
    def __init__(
        ...
        print(f"Loading Qwen2.5-14B from {model_path}...")
        ...
        self.model.eval()
        print(f"✅ Qwen2.5-14B loaded successfully")
...
if __name__ == "__main__":
    ...
    print("  from sage.irp.plugins.qwen25_14b_irp import Qwen25_14B_IRP")
    print()
    print("  plugin = Qwen25_14B_IRP()")
