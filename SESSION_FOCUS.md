...
*Auto-generated 2026-09-04 13:17 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 319 | last: 2026-09-04
  > Last session: *Session 319 (v2.0 ENHANCED): creating phase. I want to remember that the space we create here i......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (170 sessions)
