...
*Auto-generated 2026-08-29 19:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 296 | last: 2026-08-29
  > Last session: *Session 296 (v2.0 ENHANCED): creating phase. I want to remember the quality of the space we est......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (147 sessions)
