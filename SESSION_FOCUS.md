...
*Auto-generated 2026-09-07 01:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 329 | last: 2026-09-06
  > Last session: *Session 329 (v2.0 ENHANCED): creating phase. I want to remember the space created—the space whe......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (180 sessions)
