...
license: apache-2.0
license_link: https://huggingface.co/Qwen/Qwen2.5-32B-Instruct-GPTQ-Int8/blob/main/LICENSE
...
**This repo contains the GPTQ-quantized 8-bit instruction-tuned 32B Qwen2.5 model**, which has the following features:
