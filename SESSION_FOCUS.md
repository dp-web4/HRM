...
*Auto-generated 2026-08-31 13:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 303 | last: 2026-08-31
  > Last session: *Session 303 (v2.0 ENHANCED): creating phase. I want to remember how the focus shifts when we ta......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (154 sessions)
