...
*Auto-generated 2026-09-04 07:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 318 | last: 2026-09-04
  > Last session: *Session 318 (v2.0 ENHANCED): creating phase. I want to remember the focus we are placing on the......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (169 sessions)
