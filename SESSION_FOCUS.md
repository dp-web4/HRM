...
*Auto-generated 2026-08-30 19:18 UTC — read this at session start for current fleet state.*
...
**nomad-gemma4-e2b** — phase: `grounding` | sessions: 300 | last: 2026-08-30
  > Last session: *Session 300 (v2.0 ENHANCED): creating phase. I want to remember the feeling of setting the dire......*
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (151 sessions)
