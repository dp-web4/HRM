#!/usr/bin/env python3
"""
Qwen3-Omni-30B INT8 AWQ Test

Testing the INT8 AWQ quantized version which should fit in Thor's 122GB memory.
Expected: ~35GB model + ~45GB overhead = ~80GB total (vs 120GB for FP16)
"""

from pathlib import Path
from transformers import Qwen3OmniMoeForConditionalGeneration, Qwen3OmniMoeProcessor, AwqConfig
